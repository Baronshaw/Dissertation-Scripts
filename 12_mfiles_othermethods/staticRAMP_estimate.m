...
% bsub -x -q day -n 12 -R "span[hosts=1]" /nas02/apps/matlab-2012b/matlab -nodesktop -nosplash -singleCompThread -r "staticRAMP_estimate" -logfile "runall_Cluster12r.out"
...
% saving results
save(sprintf('matdata/estimation_RAMP_foriso%dkm_timezone.mat',0), ...
