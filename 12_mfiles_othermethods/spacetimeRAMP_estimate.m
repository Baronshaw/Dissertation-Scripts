function [] = spacetimeRAMP_estimate()
...
% bsub -x -q day -n 12 -R "span[hosts=1]" /nas02/apps/matlab-2012b/matlab -nodesktop -nosplash -singleCompThread -r "spacetimeRAMP_estimate" -logfile "runall_Cluster12str.out"
...
% saving results
save(sprintf('matdata/estimation_STRAMP_foriso%dkm_timezone.mat',0), ...
