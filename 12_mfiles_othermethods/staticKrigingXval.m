function [] = staticKrigingXval()
% this function will create a static (spatial only) version of kriging and 
% perform a LOOCV

% only use the following if parallel computing is needed
% bsub -x -q day -n 12 -R "span[hosts=1]" /nas02/apps/matlab-2012b/matlab -nodesktop -nosplash -singleCompThread -r "staticKrigingXval" -logfile "runall_Cluster12.out"
...
% temporary save
save(sprintf('matdata/Xvalforcediso_LOOCV_kriging_foriso%dkm_timezone.mat',floor(forceddist./1000)), ...
