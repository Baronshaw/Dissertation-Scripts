...
% estimating soft data - on-the-fly CAMP
for i = 1:11
    disp(i);
    estSoftData_CAMP(i);
end

% plot figure demonstrating on-the-fly CAMP
plotdemoCAMP();
close all;
...
% performing cross-validation for on-the-fly CAMP
for i = 1:11
    disp(i);
    getValidation_CAMP(i);
end
...
% running CAMP analysis to create maps
for i = 1:11
    disp(i);
    getBMEest_CAMP(i);
end
...
% create PAH maps from CAMP soft data
for i = 1:11
    disp(i);
    getMaps_CAMP(i);
    close all;
...
%%%%%%%%%%%%%%%%%% STAGE NINE: OCCUPATIONAL APPLICATION %%%%%%%%%%%%%%%%%%

% add part about actual exposures
%%% ADD CODE HERE
