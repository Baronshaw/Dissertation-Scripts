function [] = getValidation_CAMP(pah)
%
% GETVALIDATION_CAMP perform a cross-validation on PAH in order to determine the
...
% saving data
save(sprintf('matfiles/BMEXVal_%s_CAMP.mat',valname{pah+4}), ...
