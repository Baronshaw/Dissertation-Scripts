function [] = getMapsFires_cokrig(pah)
...
for i = 1:length(dayShow)
    ...
    title(sprintf('%s cokriging on %s with fire',valdispname{pah},datestr(dayShow(i),2)));
    ...
    print(gcf,'-painters','-dpng','-r600',sprintf('figures/Fire_BMEest_%s_cokrig_%s.png', ...
