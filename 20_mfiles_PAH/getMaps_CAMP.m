function [] = getMaps_CAMP(pah,showhard,showsoft)
...
for i = 1:length(dayShow)
    ...
    title(sprintf('Mean %s CAMP on %s',valdispname{pah},datestr(dayShow(i),2)));
    ...
    print(gcf,'-painters','-dpng','-r600',sprintf('figures/BMEest_%s_CAMP_%s.png', ...
