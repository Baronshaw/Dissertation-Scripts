function [] = recalculatelambdaGivMod()
...
% bsub -x -q day -n 12 -R "span[hosts=1]" /nas02/apps/matlab-2012b/matlab -nodesktop -nosplash -singleCompThread -r "recalculatelambdaGivMod" -logfile "recalculatelambdaGivMod.out"
...
% load data
load('recalculatelambdaGivPer.mat');
...
% save results
save('recalculatelambdaGivMod.mat','css','modplots','dailyCTMvorder', ...
