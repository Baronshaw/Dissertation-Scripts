function [] = recalculatelambdaGivMod_Constant()
...
% bsub -x -q day -n 12 -R "span[hosts=1]" /nas02/apps/matlab-2012b/matlab -nodesktop -nosplash -singleCompThread -r "recalculatelambdaGivMod_Constant" -logfile "recalculatelambdaGivMod_Constant.out"
...
% load data
load('recalculatelambdaGivPer_Constant.mat');
...
% save results
save('recalculatelambdaGivMod_Constant.mat','css','modplots','dailyCTMvorder', ...
