function [] = compareSimulambda_Constant()
...
for i = 1:length(modplots)
    for j = 1:length(unidays)
        ...
        set(gca,'xtick',[])
        set(gca,'ytick',[])
        title(sprintf('Constant: Recalculated Field of \\lambda_1 on %s given modeled %d',datestr(unidays(j)),modplots(i)));
        ...
        print(gcf,'-painters','-dpng','-r600',sprintf('figures/Constant_recalclambda1_%s_mod_%0.2d.png',datestr(unidays(j)),modplots(i)));
...
for i = 1:length(modplots)
    for j = 1:length(unidays)
        ...
        set(gca,'xtick',[])
        set(gca,'ytick',[])
        title(sprintf('Constant: Recalculated Field of \\lambda_2 on %s given modeled %d',datestr(unidays(j)),modplots(i)));
        ...
        set(gcf,'PaperPosition',[0 0 800 500]./100);
        set(gcf,'PaperPositionMode','manual');
        print(gcf,'-painters','-dpng','-r600',sprintf('figures/Constant_recalclambda2_%s_mod_%0.2d.png',datestr(unidays(j)),modplots(i)));
...
for i = 1:length(unidays)    
    ...
    set(gca,'xtick',[])
    set(gca,'ytick',[])
    title(sprintf('Constant: Recalculated Field of \\lambda_1 on %s given CMAQ modeled value',datestr(unidays(i))));
    ...
    set(gcf,'PaperPosition',[0 0 800 500]./100);
    set(gcf,'PaperPositionMode','manual');
    print(gcf,'-painters','-dpng','-r600',sprintf('figures/Constant_recalclambda1_%s_CMAQ_mod.png',datestr(unidays(i))));
...
for i = 1:length(unidays)    
    ...
    set(gca,'xtick',[])
    set(gca,'ytick',[])
    title(sprintf('Constant: Recalculated Field of \\lambda_2 on %s given CMAQ modeled value',datestr(unidays(i))));
    ...
    set(gcf,'PaperPosition',[0 0 800 500]./100);
    set(gcf,'PaperPositionMode','manual');
    print(gcf,'-painters','-dpng','-r600',sprintf('figures/Constant_recalclambda2_%s_CMAQ_mod.png',datestr(unidays(i))));
...
for i = 1:length(modplots)
    for j = 1:length(unidays)
        ...
        set(gca,'xtick',[])
        set(gca,'ytick',[])
        title(sprintf('Constant: Simulated Field of \\lambda_1 on %s given modeled %d',datestr(unidays(j)),modplots(i)));
        ...
        set(gcf,'PaperPosition',[0 0 800 500]./100);
        set(gcf,'PaperPositionMode','manual');
        print(gcf,'-painters','-dpng','-r600',sprintf('figures/Constant_simulambda1_%s_mod_%0.2d.png',datestr(unidays(j)),modplots(i)));
...
for i = 1:length(modplots)
    for j = 1:length(unidays)
        ...
        set(gca,'xtick',[])
        set(gca,'ytick',[])
        title(sprintf('Constant: Simulated Field of \\lambda_2 on %s given modeled %d',datestr(unidays(j)),modplots(i)));
        ...
        set(gcf,'PaperPosition',[0 0 800 500]./100);
        set(gcf,'PaperPositionMode','manual');
        print(gcf,'-painters','-dpng','-r600',sprintf('figures/Constant_simulambda2_%s_mod_%0.2d.png',datestr(unidays(j)),modplots(i)));
...
for i = 1:length(modplots)    
    ...
    set(gca,'xtick',[])
    set(gca,'ytick',[])
    title(sprintf('Constant: Simulated Field of \\lambda_1 on %s given CMAQ modeled value',datestr(unidays(i))));
    ...
    set(gcf,'PaperPosition',[0 0 800 500]./100);
    set(gcf,'PaperPositionMode','manual');
    print(gcf,'-painters','-dpng','-r600',sprintf('figures/Constant_simulambda1_%s_CMAQ_mod.png',datestr(unidays(i))));
...
for i = 1:length(modplots)    
    ...
    set(gca,'xtick',[])
    set(gca,'ytick',[])
    title(sprintf('Constant: Simulated Field of \\lambda_2 on %s given CMAQ modeled value',datestr(unidays(i))));
    ...
    set(gcf,'PaperPosition',[0 0 800 500]./100);
    set(gcf,'PaperPositionMode','manual');
    print(gcf,'-painters','-dpng','-r600',sprintf('figures/Constant_simulambda2_%s_CMAQ_mod.png',datestr(unidays(i))));
