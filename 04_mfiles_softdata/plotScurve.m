function [] = plotScurve(dayWHI,daysWHIdisp,n,deltaT,numbins,minpnts,modplots,...
    negval,plotnum)
...
for i = 1:plotnum
    ...
    print(gcf,'-painters','-dpdf','-r600',sprintf('../plots/Scurve_%d_%d.pdf',idxMod(i),daysWHIdisp));
