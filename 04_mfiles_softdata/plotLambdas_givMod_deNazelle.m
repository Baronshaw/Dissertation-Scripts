function [] = plotLambdas_givMod_deNazelle(dayWHI,daysWHIdisp,n,deltaT,numbins,minpnts,modplots,...
    negval)
...
for i = 1:length(modplots)
    ...
    % save figures
    h = gcf;
    print(h,'-painters','-dpdf','-r600',sprintf('../plots/map_lambda1giv%d_%d_%d_%d_%d_%d_deNazelle.pdf', ...
    ...
    % save figures
    h = gcf;
    print(h,'-painters','-dpdf','-r600',sprintf('../plots/map_lambda2giv%d_%d_%d_%d_%d_%d_deNazelle.pdf', ...
    modplots(i),daysWHIdisp,deltaT,n,minpnts,numbins));
