function [] = par_stat_MP_cmaq_gridbin(yrz)
% this function estimates the measures of traditional model performance on
% a grid within each bin of an SCurve

% bsub -x -q week -n 12 -R "span[hosts=1]" /nas02/apps/matlab-2012b/matlab -nodesktop -nosplash -singleCompThread -r "par_stat_MP_cmaq_gridbin" -logfile "par_stat_MP_cmaq_gridbin.out"
...
% save results
save('matfiles/par_traditional_performance_gridbin.mat', ...
