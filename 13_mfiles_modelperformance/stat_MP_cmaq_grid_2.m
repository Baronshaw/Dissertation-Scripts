function [] = stat_MP_cmaq_grid_2(yrz)
...
% variables 
load(sprintf('../matfiles/PM2p5_%d_90_3_150_10_neg0.mat',yrNday(1)));
...
for i = 1:length(yrNday)
    disp(i);
    load(sprintf('../matfiles/PM2p5_%d_90_3_150_10_neg0.mat',yrNday(i)));
    Mod = valMod;
    Obs = valObs;
    idx = ~isnan(Mod);
...
% save results
save('matfiles/traditional_performance_grid_2.mat', ...
