function [] = getXvalforcedisolation_10fold_test1(soft,constant,gauss,forceddist,fold)
...
% saving data
if gauss == 1
    save(sprintf('../matfiles/Xvalforcediso_10fold_fold%d%s%s%s_test1.mat',fold,softstr,constr,gaussstr), ...
