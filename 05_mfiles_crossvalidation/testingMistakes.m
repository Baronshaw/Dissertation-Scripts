function [] = testingMistakes(nsmax,krigME,soft,constant,gauss,forceddist,eststr)
    ...
    for i = 1:size(cMS,1)
        ...
        if soft == 1
            if ~isempty(ck) & sum(idxsoft) > 0
                ...
                if krigME == 1
                    [zk{i,1},vk{i,1},temp1{i,1},temp2{i,1},temp1a{i,1},temp1b{i,1},cellLamW{i,1},alllambda2{i,1}] ...
...
% temporary save
if gauss == 1
    save(sprintf('../matfiles/testingkrigME%d_nsmax%d_Xvalforcediso_LOOCV_%s%s%s_foriso%dkm_timezone%s.mat', ...
