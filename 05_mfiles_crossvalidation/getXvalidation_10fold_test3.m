function [] = getXvalidation_10fold_test3(soft,constant,gauss,fold)
...
elseif gauss == 1
    ...
    tic
    [zk,vk,temp1,temp2,temp1a,temp1b]=krigingME2_correct_parallel(ck,ch_nonXval,css,...
...
% saving data
if gauss == 1
    save(sprintf('../matfiles/Xval_10fold_fold%d%s%s%s_test3.mat',fold,softstr,constr,gaussstr), ...
