function [] = getXvalforcedisolationStatistics_LOOCV_test1(soft,constant,gauss)
...
for i = 1:12  
    load(sprintf('../matfiles/Xvalforcediso_LOOCV_mon%d_%s%s%s_test1.mat',i,softstr,constr,gaussstr));
...
% save results
save(sprintf('Xvalforcediso_LOOCV%s%s%s_results_test1.mat',softstr,constr,gaussstr),...
