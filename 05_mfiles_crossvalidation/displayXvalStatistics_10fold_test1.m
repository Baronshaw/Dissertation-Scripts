function [] = displayXvalStatistics_10fold_test1(soft,constant,gauss)
...
outid = fopen(sprintf('Xval_10fold%s%s%s_alldaily_test1.csv',softstr,constr,gaussstr),'w+');
fprintf(outid,'%s',strval);
fclose(outid);
dlmwrite(sprintf('Xval_10fold%s%s%s_alldaily_test1.csv',softstr,constr,gaussstr), ...
...
outid = fopen(sprintf('Xval_10fold%s%s%s_folddaily_test1.csv',softstr,constr,gaussstr),'w+');
fprintf(outid,'%s',strval);
fclose(outid);
dlmwrite(sprintf('Xval_10fold%s%s%s_folddaily_test1.csv',softstr,constr,gaussstr), ...
    n,'delimiter',',','precision',6,'-append','roffset',1)
...
outid = fopen(sprintf('Xval_10fold%s%s%s_monthdaily_test1.csv',softstr,constr,gaussstr),'w+');
fprintf(outid,'%s',strval);
fclose(outid);
dlmwrite(sprintf('Xval_10fold%s%s%s_monthdaily_test1.csv',softstr,constr,gaussstr), ...
    n,'delimiter',',','precision',6,'-append','roffset',1)
...
outid = fopen(sprintf('Xval_10fold%s%s%s_seasondaily_test1.csv',softstr,constr,gaussstr),'w+');
fprintf(outid,'%s',strval);
fclose(outid);
dlmwrite(sprintf('Xval_10fold%s%s%s_seasondaily_test1.csv',softstr,constr,gaussstr), ...
    n,'delimiter',',','precision',6,'-append','roffset',1)
...
outid = fopen(sprintf('Xval_10fold%s%s%s_yeardaily_test1.csv',softstr,constr,gaussstr),'w+');
fprintf(outid,'%s',strval);
fclose(outid);
dlmwrite(sprintf('Xval_10fold%s%s%s_yeardaily_test1.csv',softstr,constr,gaussstr), ...
    n,'delimiter',',','precision',6,'-append','roffset',1)
...
outid = fopen(sprintf('Xval_10fold%s%s%s_regiondaily_test1.csv',softstr,constr,gaussstr),'w+');
fprintf(outid,'%s',strval);
fclose(outid);
dlmwrite(sprintf('Xval_10fold%s%s%s_regiondaily_test1.csv',softstr,constr,gaussstr), ...
    n,'delimiter',',','precision',6,'-append','roffset',1)
...
n = [n_sitesyrs n_observationsyrs RMSEyrs MAEyrs MEyrs r2yrs MSyrs RMSSyrs MRyrs std_estyrs std_obsyrs ...
    QAr2yrs];
outid = fopen(sprintf('Xval_10fold%s%s%s_allyearly_test1.csv',softstr,constr,gaussstr),'w+');
fprintf(outid,'%s',strval);
fclose(outid);
dlmwrite(sprintf('Xval_10fold%s%s%s_allyearly_test1.csv',softstr,constr,gaussstr), ...
    n,'delimiter',',','precision',6,'-append','roffset',1)
...
outid = fopen(sprintf('Xval_10fold%s%s%s_foldyearly_test1.csv',softstr,constr,gaussstr),'w+');
fprintf(outid,'%s',strval);
fclose(outid);
dlmwrite(sprintf('Xval_10fold%s%s%s_foldyearly_test1.csv',softstr,constr,gaussstr), ...
    n,'delimiter',',','precision',6,'-append','roffset',1)
...
outid = fopen(sprintf('Xval_10fold%s%s%s_yearyearly_test1.csv',softstr,constr,gaussstr),'w+');
fprintf(outid,'%s',strval);
fclose(outid);
dlmwrite(sprintf('Xval_10fold%s%s%s_yearyearly_test1.csv',softstr,constr,gaussstr), ...
    n,'delimiter',',','precision',6,'-append','roffset',1)
...
outid = fopen(sprintf('Xval_10fold%s%s%s_regionyearly_test1.csv',softstr,constr,gaussstr),'w+');
fprintf(outid,'%s',strval);
fclose(outid);
dlmwrite(sprintf('Xval_10fold%s%s%s_regionyearly_test1.csv',softstr,constr,gaussstr), ...
    n,'delimiter',',','precision',6,'-append','roffset',1)
...
outid = fopen(sprintf('Xval_10fold%s%s%s_alldailydists_test1.csv',softstr,constr,gaussstr),'w+');
fprintf(outid,'%s',strval);
fclose(outid);
dlmwrite(sprintf('Xval_10fold%s%s%s_alldailydists_test1.csv',softstr,constr,gaussstr), ...
    n,'delimiter',',','precision',6,'-append','roffset',1)

% table by fold daily
n = [n_sites_fold' n_observations_fold' RMSE_fold' MAE_fold' ME_fold' r2_fold' ...
    MS_fold' RMSS_fold' MR_fold' std_est_fold' std_obs_fold' QAr2_fold' dists_info_fold'];
outid = fopen(sprintf('Xval_10fold%s%s%s_folddailydists_test1.csv',softstr,constr,gaussstr),'w+');
fprintf(outid,'%s',strval);
fclose(outid);
dlmwrite(sprintf('Xval_10fold%s%s%s_folddailydists_test1.csv',softstr,constr,gaussstr), ...
    n,'delimiter',',','precision',6,'-append','roffset',1)

% table by year daily
n = [n_sites_year' n_observations_year' RMSE_year' MAE_year' ME_year' r2_year' ...
    MS_year' RMSS_year' MR_year' std_est_year' std_obs_year' QAr2_year' dists_info_year'];
outid = fopen(sprintf('Xval_10fold%s%s%s_yeardailydists_test1.csv',softstr,constr,gaussstr),'w+');
fprintf(outid,'%s',strval);
fclose(outid);
dlmwrite(sprintf('Xval_10fold%s%s%s_yeardailydists_test1.csv',softstr,constr,gaussstr), ...
    n,'delimiter',',','precision',6,'-append','roffset',1)

% table by EPA region daily
n = [n_sites_EPA' n_observations_EPA' RMSE_EPA' MAE_EPA' ME_EPA' r2_EPA' MS_EPA' ...
    RMSS_EPA' MR_EPA' std_est_EPA' std_obs_EPA' QAr2_EPA' dists_info_EPA'];
outid = fopen(sprintf('Xval_10fold%s%s%s_regiondailydists_test1.csv',softstr,constr,gaussstr),'w+');
fprintf(outid,'%s',strval);
fclose(outid);
dlmwrite(sprintf('Xval_10fold%s%s%s_regiondailydists_test1.csv',softstr,constr,gaussstr), ...
    n,'delimiter',',','precision',6,'-append','roffset',1)
