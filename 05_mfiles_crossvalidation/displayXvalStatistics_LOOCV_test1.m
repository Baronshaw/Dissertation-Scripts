function [] = displayXvalStatistics_LOOCV_test1(soft,constant,gauss)
...
% load data
load(sprintf('Xval_LOOCV%s%s%s_results_test1.mat',softstr,constr,gaussstr));
...
outid = fopen(sprintf('Xval_LOOCV%s%s%s_alldaily_test1.csv',softstr,constr,gaussstr),'w+');
fprintf(outid,'%s',strval);
fclose(outid);
dlmwrite(sprintf('Xval_LOOCV%s%s%s_alldaily_test1.csv',softstr,constr,gaussstr), ...
...
outid = fopen(sprintf('Xval_LOOCV%s%s%s_monthdaily_test1.csv',softstr,constr,gaussstr),'w+');
fprintf(outid,'%s',strval);
fclose(outid);
dlmwrite(sprintf('Xval_LOOCV%s%s%s_monthdaily_test1.csv',softstr,constr,gaussstr), ...
    n,'delimiter',',','precision',6,'-append','roffset',1)
...
outid = fopen(sprintf('Xval_LOOCV%s%s%s_seasondaily_test1.csv',softstr,constr,gaussstr),'w+');
fprintf(outid,'%s',strval);
fclose(outid);
dlmwrite(sprintf('Xval_LOOCV%s%s%s_seasondaily_test1.csv',softstr,constr,gaussstr), ...
    n,'delimiter',',','precision',6,'-append','roffset',1)
...
outid = fopen(sprintf('Xval_LOOCV%s%s%s_yeardaily_test1.csv',softstr,constr,gaussstr),'w+');
fprintf(outid,'%s',strval);
fclose(outid);
dlmwrite(sprintf('Xval_LOOCV%s%s%s_yeardaily_test1.csv',softstr,constr,gaussstr), ...
    n,'delimiter',',','precision',6,'-append','roffset',1)
...
outid = fopen(sprintf('Xval_LOOCV%s%s%s_regiondaily_test1.csv',softstr,constr,gaussstr),'w+');
fprintf(outid,'%s',strval);
fclose(outid);
dlmwrite(sprintf('Xval_LOOCV%s%s%s_regiondaily_test1.csv',softstr,constr,gaussstr), ...
    n,'delimiter',',','precision',6,'-append','roffset',1)
...
n = [n_sitesyrs n_observationsyrs RMSEyrs MAEyrs MEyrs r2yrs MSyrs RMSSyrs MRyrs std_estyrs std_obsyrs ...
    QAr2yrs];
outid = fopen(sprintf('Xval_LOOCV%s%s%s_allyearly_test1.csv',softstr,constr,gaussstr),'w+');
fprintf(outid,'%s',strval);
fclose(outid);
dlmwrite(sprintf('Xval_LOOCV%s%s%s_allyearly_test1.csv',softstr,constr,gaussstr), ...
    n,'delimiter',',','precision',6,'-append','roffset',1)
...
outid = fopen(sprintf('Xval_LOOCV%s%s%s_yearyearly_test1.csv',softstr,constr,gaussstr),'w+');
fprintf(outid,'%s',strval);
fclose(outid);
dlmwrite(sprintf('Xval_LOOCV%s%s%s_yearyearly_test1.csv',softstr,constr,gaussstr), ...
    n,'delimiter',',','precision',6,'-append','roffset',1)
...
outid = fopen(sprintf('Xval_LOOCV%s%s%s_regionyearly_test1.csv',softstr,constr,gaussstr),'w+');
fprintf(outid,'%s',strval);
fclose(outid);
dlmwrite(sprintf('Xval_LOOCV%s%s%s_regionyearly_test1.csv',softstr,constr,gaussstr), ...
    n,'delimiter',',','precision',6,'-append','roffset',1)
...
outid = fopen(sprintf('Xval_LOOCV%s%s%s_alldailydists_test1.csv',softstr,constr,gaussstr),'w+');
fprintf(outid,'%s',strval);
fclose(outid);
dlmwrite(sprintf('Xval_LOOCV%s%s%s_alldailydists_test1.csv',softstr,constr,gaussstr), ...
    n,'delimiter',',','precision',6,'-append','roffset',1)

% table by year daily
n = [n_sites_year' n_observations_year' RMSE_year' MAE_year' ME_year' r2_year' ...
    MS_year' RMSS_year' MR_year' std_est_year' std_obs_year' QAr2_year' dists_info_year'];
outid = fopen(sprintf('Xval_LOOCV%s%s%s_yeardailydists_test1.csv',softstr,constr,gaussstr),'w+');
fprintf(outid,'%s',strval);
fclose(outid);
dlmwrite(sprintf('Xval_LOOCV%s%s%s_yeardailydists_test1.csv',softstr,constr,gaussstr), ...
    n,'delimiter',',','precision',6,'-append','roffset',1)

% table by EPA region daily
n = [n_sites_EPA' n_observations_EPA' RMSE_EPA' MAE_EPA' ME_EPA' r2_EPA' MS_EPA' ...
    RMSS_EPA' MR_EPA' std_est_EPA' std_obs_EPA' QAr2_EPA' dists_info_EPA'];
outid = fopen(sprintf('Xval_LOOCV%s%s%s_regiondailydists_test1.csv',softstr,constr,gaussstr),'w+');
fprintf(outid,'%s',strval);
fclose(outid);
dlmwrite(sprintf('Xval_LOOCV%s%s%s_regiondailydists_test1.csv',softstr,constr,gaussstr), ...
    n,'delimiter',',','precision',6,'-append','roffset',1)
