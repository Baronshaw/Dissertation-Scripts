function [] = runall_Cluster_11d2(FOLDIDX)
...
for i = 1:length(CTMyears) 
    ...
    lib(lib==0)=[];
    mIsoft_nonXval(isnan(mIsoft_nonXval)) = 0; % added 9/28/2014
    disp(sum(isnan(mIsoft_nonXval)));
...
save(sprintf('../matfiles/Xval_true10fold_fold%d.mat',FOLDIDX), ...
